...
If you have https://sonarqube.org[SonarQube] installed, you only need to https://repo.maven.apache.org/maven2/com/devonfw/tools/sonar-devon4j-plugin/[download] and copy the latest version of this `sonar-devon4j-plugin` into the `extensions/plugins` folder of your SonarQube installation.
